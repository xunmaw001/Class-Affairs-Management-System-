  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='班级名称' prop="clazzName">
                 <el-input v-model="ruleForm.clazzName" :disabled="true" placeholder="班级名称"></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='xuesheng'" label='班级位置' prop="clazzAddress">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.clazzId)&& 'xuesheng'==this.flag){
