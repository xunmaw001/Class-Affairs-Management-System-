    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="chengjifenshu">
                       <el-input v-model="ruleForm.chengjifenshu"
                                 placeholder="成绩" clearable  :readonly="ro.chengjifenshu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="成绩" prop="chengjifenshu">
                           <el-input v-model="ruleForm.chengjifenshu"
