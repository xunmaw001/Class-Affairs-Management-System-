    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(false)
            ...
            XueshengEntity xueshengEntity = xueshengService.selectById(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            if(xueshengEntity.getClazzId() != null){
                params.put("clazzId",xueshengEntity.getClazzId());
            }
        }
